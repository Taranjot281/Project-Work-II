...
export class ProductService {
    ...
    private productUrl = `http://ecommerce-env.eba-zyvqhcp9.us-east-2.elasticbeanstalk.com/api/product`;
    private categoryUrl = `http://ecommerce-env.eba-zyvqhcp9.us-east-2.elasticbeanstalk.com/api/category`;
    ...
    update(productInfo: ProductInfo): Observable<ProductInfo> {
        const url = `http://ecommerce-env.eba-zyvqhcp9.us-east-2.elasticbeanstalk.com/api/seller/product/${productInfo.productId}/edit`;
        return this.http.put<ProductInfo>(url, productInfo);
    }

    create(productInfo: ProductInfo): Observable<ProductInfo> {
        const url = `http://ecommerce-env.eba-zyvqhcp9.us-east-2.elasticbeanstalk.com/api/seller/product/new`;
        return this.http.post<ProductInfo>(url, productInfo);
    }


    delelte(productInfo: ProductInfo): Observable<any> {
        const url = `http://ecommerce-env.eba-zyvqhcp9.us-east-2.elasticbeanstalk.com/api/seller/product/${productInfo.productId}/delete`;
